...
Feature target: crop, arrow, line, rectangle/ellipse, freehand, text, highlight,
blur/pixelate, step numbers, plus copy/save/upload actions from inside the
editor.
...
### P4c - Full annotation feature set (copy/save/upload in-editor)
