...
func TestNextcloudUpload(t *testing.T) {
	...
	if want := "/remote.php/dav/files/uploads/shot.png"; putPath != want {
	...
	if putUser != "uploads@example.com" {
...
func TestNextcloudDirectURLByMime(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.mime, func(t *testing.T) {
			...
			nc := NewNextcloud(NextcloudConfig{BaseURL: srv.URL, Username: "uploads@example.com", Password: "pw"}, srv.Client())
...
func TestNextcloudRemoteDirAndDavUser(t *testing.T) {
	...
	if want := "/remote.php/dav/files/uploads/Screenshots/a.png"; putPath != want {
		t.Errorf("PUT path = %q, want %q", putPath, want)
	}
